...
<app:application xmlns:app="http://www.sierrawireless.com/airvantage/application/1.0" name="legatoHashMap" type="" revision="unknown">
  <application-manager use="LWM2M_SW"/>
  <capabilities>
    <communication use="legato"/>
    <data>
      <encoding type="LWM2M">
        <asset default-label="Application Objects" id="le_legatoHashMap">
