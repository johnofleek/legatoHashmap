...
// Startup code for the executable 'legatoHashMap'.
...
LE_SHARED le_log_SessionRef_t legatoHashMap_exe_LogSession;
LE_SHARED le_log_Level_t* legatoHashMap_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    legatoHashMap_exe_LogSession = log_RegComponent("legatoHashMap_exe", &legatoHashMap_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_hashComponent.so");
